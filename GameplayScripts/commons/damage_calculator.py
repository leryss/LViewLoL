...
def get_damage_specification(champ) -> Optional[DamageSpecification]:
    ...
    if champ.name == "darius":
        ...
        if champ.Q.level == 1:
            ...
            spec.base_damage = 80.0
        elif champ.Q.level == 3:
            spec.base_damage = 110.0
        elif champ.Q.level == 4:
            spec.base_damage = 140.0
        elif champ.Q.level == 5:
            spec.base_damage = 170.0

        if champ.W.level == 1:
            spec.base_damage = 140.0
        elif champ.W.level == 2:
            spec.base_damage = 145.0
        elif champ.W.level == 3:
            spec.base_damage = 150.0
        elif champ.W.level == 4:
            spec.base_damage = 155.0
        elif champ.W.level == 5:
            spec.base_damage = 160.0
        ...
        if champ.Q.level == 1:
            ...
            spec.base_damage = 115.0
        elif champ.Q.level == 3:
            spec.base_damage = 150.0
        elif champ.Q.level == 4:
            spec.base_damage = 185.0
        elif champ.Q.level == 5:
            spec.base_damage = 220.0
        ...
        if champ.R.level == 1:
            spec.base_damage = 113.0
        elif champ.R.level == 2:
            spec.base_damage = 213.0
        elif champ.R.level == 3:
            spec.base_damage = 413.0
        ...
        spec.percent_ad = 0.75
        if champ.Q.level == 1:
            spec.base_damage = 20.0
        elif champ.Q.level == 2:
            spec.base_damage = 45.0
        elif champ.Q.level == 3:
            spec.base_damage = 70.0
        elif champ.Q.level == 4:
            spec.base_damage = 95.0
        elif champ.Q.level == 5:
            spec.base_damage = 120.0

        if champ.E.level == 1:
            spec.base_damage = 60.0
        elif champ.E.level == 2:
            spec.base_damage = 70.0
        elif champ.E.level == 3:
            spec.base_damage = 80.0
        ...
        if champ.R.level == 1:
            ...
            spec.base_damage = 350.0
        elif champ.R.level == 3:
            spec.base_damage = 500.0

    elif champ.name == "brand":
